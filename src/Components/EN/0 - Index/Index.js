...
export default function Index(props) {
  ...
  const handleDrawerClose = () => {
    ...
    if (openCommunityMenu) {setOpenCommunityMenu(false)};
    setOpen(false);
    setShowText(false);
  };
  ...
  return (
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open} className={classNames('navigation', { dark: !props.light, light: props.light })}>
        <DrawerHeader>
          <IconButton onClick={handleDrawerClose}>
            {theme.direction === 'rtl' ? <ChevronRightIcon sx={ (props.light !== true) ? {color: 'white'} : null}/> : <ChevronLeftIcon sx={ (props.light !== true) ? {color: 'white'} : null}/>}
          </IconButton>
        </DrawerHeader>
        <Divider />
        ...
        <List>       
            <Link to="/">
              <ListItem button>
                <ListItemIcon>
                  <CelebrationIcon sx={ (props.light !== true) ? {color: 'white'} : null}/>
                </ListItemIcon>
                <Fade in={showText}
                easing={{
        ...
        <List>
            <Link to="/info-NFT">
              <ListItem button onClick={() => {
                 ...
                 if (openCommunityMenu) {setOpenCommunityMenu(false)};}}>
                <ListItemIcon>
                <MenuBookIcon sx={ (props.light !== true) ? {color: 'white'} : null}/>
                </ListItemIcon>
                <Fade in={showText}
                easing={{
                enter: "cubic-bezier(.99,0,1,1.62)",
                ...
                timeout={{enter: 666, exit: 0}}>
                <ListItemText primary={'General Information about NFT'} primaryTypographyProps={{ style: { whiteSpace: "normal"} }}/>
                </Fade>
                {openGeneralNFTMenu ? <ExpandLessIcon /> : <ExpandLessIcon className='rotate'/>}
              </ListItem>
            </Link>
          ...
          <Link to="/">
              <ListItem button sx={{ pl: 4 }}>
                <ListItemIcon>
                <Filter1Icon sx={ (props.light !== true) ? {color: 'white'} : null}/>
                </ListItemIcon>
            ...
            <Link to="/">
              <ListItem button sx={{ pl: 4 }}>
                <ListItemIcon>
                <Filter2Icon sx={ (props.light !== true) ? {color: 'white'} : null}/>
                </ListItemIcon>
            ...
            <Link to="/">
              <ListItem button sx={{ pl: 4 }}>
                <ListItemIcon>
                <Filter3Icon sx={ (props.light !== true) ? {color: 'white'} : null}/>
                </ListItemIcon>
            ...
            <Link to="/">
              <ListItem button sx={{ pl: 4 }}>
                <ListItemIcon>
                <Filter4Icon sx={ (props.light !== true) ? {color: 'white'} : null}/>
                </ListItemIcon>
            ...
            <Link to="/sell-NFT">
              <ListItem button onClick={() => {
                 ...
                 if (openCommunityMenu) {setOpenCommunityMenu(false)};}}>
                <ListItemIcon>
                <AddBusinessIcon sx={ (props.light !== true) ? {color: 'white'} : null}/>
                </ListItemIcon>
                <Fade in={showText}
                easing={{
                enter: "cubic-bezier(.99,0,1,1.62)",
                ...
                timeout={{enter: 666, exit: 0}}>
                <ListItemText primary={'How to Mint and List your NFT'} primaryTypographyProps={{ style: { whiteSpace: "normal"} }}/>
                </Fade>
                {openSellNFTMenu ? <ExpandLessIcon /> : <ExpandLessIcon className='rotate'/>}
              </ListItem>
            </Link>
        ...
        >
          <Link to="/">
            ...
            <Link to="/">
              <ListItem button sx={{ pl: 4 }}>
                <ListItemIcon>
                <Filter5Icon sx={ (props.light !== true) ? {color: 'white'} : null}/>
                </ListItemIcon>
            ...
            <Link to="/">
              <ListItem button sx={{ pl: 4 }}>
                <ListItemIcon>
                <Filter6Icon sx={ (props.light !== true) ? {color: 'white'} : null}/>
                </ListItemIcon>
            ...
            <Link to="/">
              <ListItem button sx={{ pl: 4 }}>
                <ListItemIcon>
                <CakeIcon sx={ (props.light !== true) ? {color: 'white'} : null}/>
                </ListItemIcon>
            ...
            <Link to="/">
              <ListItem button sx={{ pl: 4 }}>
                <ListItemIcon>
                <LocalGasStationIcon sx={ (props.light !== true) ? {color: 'white'} : null}/>
                </ListItemIcon>
      ...
      <List>
            ...
            <ListItem button onClick={() => {
                    ...
                    if (openSellNFTMenu) {setOpenSellNFTMenu(false)};}}>
                <ListItemIcon>
                  <MapsHomeWorkIcon sx={ (props.light !== true) ? {color: 'white'} : null}/>
                </ListItemIcon>
                <Fade in={showText}
                easing={{
                  enter: "cubic-bezier(.99,0,1,1.62)",
                ...
                {openCommunityMenu ? <ExpandLessIcon /> : <ExpandLessIcon className='rotate'/>}
              </ListItem>
            </Link>
          ...
          <Link to="/">
              <ListItem button sx={{ pl: 4 }}>
                <ListItemIcon>
                <SpeakerNotesIcon sx={ (props.light !== true) ? {color: 'white'} : null}/>
                </ListItemIcon>
            ...
            <Link to="/">
              <ListItem button sx={{ pl: 4 }}>
                <ListItemIcon>
                <FactCheckIcon sx={ (props.light !== true) ? {color: 'white'} : null}/>
                </ListItemIcon>
            ...
            <Link to="/reverse-img-search">
              <ListItem button>
                ...
                easing={{
                  ...
                  timeout={{enter: 666, exit: 0}}>
                <ListItemText primary="Reverse Image Search Resources" primaryTypographyProps={{ style: { whiteSpace: "normal"} }}/>
                </Fade>
              </ListItem>
            </Link>
      </List>
