      ...
      <div className="m-10">
        ...
        <div>
          <ol className="list-decimal ml-6">
            ...
            <li className="mt-1">
              コレクションに必要な情報を入力します。 (ロゴ画像、 コレクション名)
              <Card
                color="pink"
            ...
            <ul className="list-none">
              <li className="mt-1">
                <Typography variant="h4" color="inherit" component="h4" mt={2}>
        ...
        <div>
          <Typography variant="h2" color="inherit" component="h2" mt={2} mb={1}>
