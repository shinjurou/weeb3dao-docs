      ...
      <div className="m-10">
        ...
        <Card
          ...
          content={[
            <>
              ...
              그리고{" "}
              <Link link="https://twitter.com/uwucrewnft" title="uwucrew" />는
              어떤 프로젝트인가요?
            </>,
          ]}
        />
        ...
        <div className="grid grid-cols-1 divide-y-2 divide-gray-400/25 divide-dashed">
          <div>
            ...
            <div className="mt-3">
              <Link link="https://twitter.com/weeb3dao" title="weeb3dao" />는 '
              ...
              <Link
                ...
                title="SaltSeaCake"
              />
              '가 만든 NFT 프로젝트에서 시작된 DAO입니다.
            </div>
            <div className="mt-2">
              지금은 아티스트들이 NFT 커뮤니티에 정착할 수 있도록 돕기 위해
              노력하는 작은 콜렉터와 아티스트들의 '그룹'이 되었습니다. (콜렉터,
              아티스트 모두 AnifamNFT와 uwucrew에도 속해있습니다.)
            </div>
